...
<div class="col-8">
    <div class="card ">
        <div class="card-header  text-center">RESULTAT DEPARTEMENT : @if(!empty($departement)) {{$departement->nom}} @endif /  {{$depouillement[0]}} dépouillé sur {{$depouillement[1] + $depouillement[0]}} : @if($depouillement[1]+$depouillement[0] > 0) {{round($depouillement[0]/($depouillement[1]+$depouillement[0]),2) * 100}}%  @endif </div>
            <div class="card-body">
