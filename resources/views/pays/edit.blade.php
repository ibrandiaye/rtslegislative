    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('pays.index') }}" >RETOUR</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control" name="juridiction_id" required="">
                                        ...
                                        <option {{old('juridiction_id', $pays->juridiction_id) == $juridiction->id ? 'selected' : ''}}
                                            value="{{$juridiction->id}}">{{$juridiction->nom}}</option>
                                            @endforeach
