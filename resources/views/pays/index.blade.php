    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('pays.create') }}">ENREGISTRER pays</a></li>
                                </ol>
                            </div>
...
<div class="col-12">
    <div class="card ">
        <div class="card-header">LISTE D'ENREGISTREMENT DES Pays</div>
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($payss as $pays)
                        <tr>
                            <td>{{ $pays->id }}</td>
                            <td>{{ $pays->nom }}</td>
                            <td>{{ $pays->juridiction->nom }}</td>
                            <td>
                                <a href="{{ route('pays.edit', $pays->id) }}" role="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                ...
                <div class="modal fade" id="exampleModalform2" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="{{ route('importer.pays') }}" method="POST" enctype="multipart/form-data">
                                @csrf
